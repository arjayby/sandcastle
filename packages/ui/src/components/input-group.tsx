// biome-ignore-all lint/a11y/useKeyWithClickEvents: The addon click only forwards focus to the keyboard-accessible input.
// biome-ignore-all lint/a11y/useSemanticElements: These compositional groups are not form fieldsets.
